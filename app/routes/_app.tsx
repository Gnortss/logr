  ...
  return (
    <div className="min-h-screen bg-bg">
      <header className="sticky top-0 z-10 bg-bg-card border-b border-border px-4 py-3 flex items-center justify-between">
        <Link to="/" className="text-xl font-bold text-accent">Logr</Link>
        <Link to="/settings" className="p-2 rounded-lg hover:bg-border transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center" aria-label="Settings">
